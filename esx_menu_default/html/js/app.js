(function(){
	...
	let MenuTpl =
		'<div id="menu_{{_namespace}}_{{_name}}" class="menu{{#align}} align-{{align}}{{/align}}">' +
			'<div><img style="display:block;margin-left:auto;margin-right:auto;object-position:50% 50%;width:50%;object-fit:cover" alt="logofont.png" data-type="image" itemprop="image" src="https://static.wixstatic.com/media/e063d5_9e1ab37b2a124da884f5fe2878f03df9~mv2.png/v1/fill/w_253,h_39,al_c,q_85,usm_0.66_1.00_0.01/logofont.webp"></div>' +
