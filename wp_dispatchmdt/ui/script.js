    ...
    methods: {
        changePage(page) {
            ...
            switch (page) {
                ...
                case "Warrants": {
                    $.post("http://wp_dispatchmdt/getWarrants", JSON.stringify({}));
                    $("#warrants").addClass("nav-active");
                    break;
                }
                case "Bolos": {
                    $.post("http://wp_dispatchmdt/getBolos", JSON.stringify({}));
        ...
        closeMDT() {
            $.post("http://wp_dispatchmdt/close", JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {
                this.offender_results.query = this.offender_search;

                $.post("http://wp_dispatchmdt/performOffenderSearch", JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (let key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    $.post("http://wp_dispatchmdt/viewOffender", JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post("http://wp_dispatchmdt/saveOffenderChanges", JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post("http://wp_dispatchmdt/performReportSearch", JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post("http://wp_dispatchmdt/submitNewReport", JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post("http://wp_dispatchmdt/getOffender", JSON.stringify({
                char_id: id
            }));
        },
        ToggleReportEdit() {
        ...
        DeleteSelectedReport() {
            $.post("http://wp_dispatchmdt/deleteReport", JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post("http://wp_dispatchmdt/saveReportChanges", JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post("http://wp_dispatchmdt/vehicleSearch", JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post("http://wp_dispatchmdt/getVehicle", JSON.stringify({
                vehicle: result
            }));
        },
        WarrantReportSearch() {
        ...
        SubmitNewWarrant() {
            ...
            $.post("http://wp_dispatchmdt/submitNewWarrant", JSON.stringify({
        ...
        SubmitNewBolo() {
            ...
            $.post("http://wp_dispatchmdt/submitNewBolo", JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post("http://wp_dispatchmdt/deleteWarrant", JSON.stringify({
        ...
        DeleteSelectedBolo() {
            $.post("http://wp_dispatchmdt/deleteBolo", JSON.stringify({
        ...
        OpenReportById(id) {
            $.post("http://wp_dispatchmdt/getReport", JSON.stringify({
                id: id
            }));
        },
        ...
        SentencePlayer() {
            $.post("http://wp_dispatchmdt/sentencePlayer", JSON.stringify({
                id: this.report_selected.id,
