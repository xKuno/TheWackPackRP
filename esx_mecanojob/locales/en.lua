Locales['en'] = {
  ...
  ['please_drop_off']           = 'please drop off the vehicle at the DoT building',
  ['cant_attach_own_tt']        = 'You can\'t~s~ attach own tow truck',
  ...
  ['imp_flatbed']               = 'Action impossible! You need a Flatbed for it',
  ['objects']                   = 'objects',
  ['roadcone']                  = 'roadcone',
  ['toolbox']                   = 'toolbox',
  ...
  ['used_kit']                  = 'You used a repair kit',
  ['must_be_outside']           = 'You have to be outside of the vehicle to repair it',
  ['no_vehicle_nearby']         = 'There is no ~r~vehicle ~w~nearby',
  ['finished_repair']           = 'You repaired the vehicle',
  ['abort_hint']                = 'Press ~INPUT_VEH_DUCK~ to cancel',
  ['aborted_repair']            = 'You stopped repairing the vehicle',
}
