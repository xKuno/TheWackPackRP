...
Config.RunAmount = math.random(5,10) -- How many drop offs the player does before it automatixally stops.
...
Config.OxyChance = 1000 -- Percentage chance of getting oxy on the run. Multiplied by 100. 10% = 100, 20% = 200, 50% = 500, etc. Default 55%.
...
Config.BigRewarditem = "gruppe62fleeca" -- Put a rare item here which will have 0.1% chance of being given on the run.
