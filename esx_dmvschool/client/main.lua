...
function StopTheoryTest(success)
	...
	if success then
        ...
        exports['mythic_notify']:SendAlert('inform', 'You passed the test.', 2500, { ['background-color'] = '#00b51e', ['color'] = '#ffffff' })
	else
        exports['mythic_notify']:SendAlert('inform', 'You failed the test.', 2500, { ['background-color'] = '#b50000', ['color'] = '#ffffff' })
	end
end
	...
	while true do
		...
		if CurrentTest == 'drive' then
			...
			if Config.CheckPoints[nextCheckPoint] == nil then
                ...
                exports['mythic_notify']:SendAlert('inform', 'You completed your driving test.', 2500, { ['background-color'] = '#00b51e', ['color'] = '#ffffff' })
		...
		if CurrentTest == 'drive' then
			...
			if IsPedInAnyVehicle(playerPed, false) then
				...
				for k,v in pairs(Config.SpeedLimits) do
					if CurrentZoneType == k and speed > v then
						...
						if not IsAboveSpeedLimit then
                            ...
                            exports['mythic_notify']:SendAlert('inform', 'Driving too fast.', 2500, { ['background-color'] = '#b50000', ['color'] = '#ffffff' })
                            exports['mythic_notify']:SendAlert('inform', 'You got an errors.', 2500, { ['background-color'] = '#b50000', ['color'] = '#ffffff' })
						end
					end
				end
				...
				if health < LastVehicleHealth then
                    ...
                    exports['mythic_notify']:SendAlert('inform', 'You damaged your vehicle.', 2500, { ['background-color'] = '#b50000', ['color'] = '#ffffff' })
                    exports['mythic_notify']:SendAlert('inform', 'You got an errors.', 2500, { ['background-color'] = '#b50000', ['color'] = '#ffffff' })
