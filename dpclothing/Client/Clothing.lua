...
local Drawables = {
	...
	["Shoes"] = {
		...
		Emote = { Dict = "random@domestic", Anim = "pickup_low", Move = 0, Dur = 1200 } -- Good Male
	},
	["Neck"] = {
		Drawable = 7,
		Table = { Standalone = true, Male = 0, Female = 0 },
		Emote = { Dict = "clothingtie", Anim = "try_tie_positive_a", Move = 51, Dur = 2100 } -- Good Male/Female
	},
	["Vest"] = {
		Drawable = 9,
		Table = { Standalone = true, Male = 0, Female = 0 },
		Emote = { Dict = "clothingtie", Anim = "try_tie_negative_a", Move = 51, Dur = 1200 } -- Good Male/Female
	},
	["Bag"] = {
		Drawable = 5,
	...
	["Mask"] = {
		Drawable = 1,
		Table = { Standalone = true, Male = 0, Female = 0 },
		Emote = { Dict = "mp_masks@standard_car@ds@", Anim = "put_on_mask", Move = 51, Dur = 800 } -- Good Male/Female
	},
	["Hair"] = {
		Drawable = 2,
...
local Extras = {
	["Shirt"] = {
		Drawable = 11,
		Table = {
			Standalone = true, Male = 350, Female = 56,  -- Good Male/Female
			Extra = { 
	...
	["Pants"] = {
		Drawable = 4,
		Table = { Standalone = true, Male = 92, Female = 38 },
		Emote = { Dict = "re@construction", Anim = "out_of_breath", Move = 51, Dur = 1300 } -- Good Male/Female
	},
	["Bagoff"] = {
		Drawable = 5,
		Table = { Standalone = true, Male = 0, Female = 0 },
...
local Props = {
	...
	["Hat"] = {
		Prop = 0,
		Emote = {
			On = { Dict = "mp_masks@standard_car@ds@", Anim = "put_on_mask", Move = 51, Dur = 600 }, -- Good Male/Female
			Off = { Dict = "missheist_agency2ahelmet", Anim = "take_off_helmet_stand", Move = 51, Dur = 1200 }
		}
	},
	["Glasses"] = {
		Prop = 1,
		Emote = {
			On = { Dict = "clothingspecs", Anim = "take_off", Move = 51, Dur = 1400 }, -- Good Male/Female
