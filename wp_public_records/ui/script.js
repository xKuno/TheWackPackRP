    ...
    methods: {
        changePage(page) {
            ...
            switch (page) {
                ...
                case "Warrants": {
                    $.post("http://wp_public_records/getWarrants", JSON.stringify({}));
                    $("#warrants").addClass("nav-active");
                    break;
                }
                case "Bolos": {
                    $.post("http://wp_public_records/getBolos", JSON.stringify({}));
        ...
        closeMDT() {
            $.post("http://wp_public_records/close", JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {
                this.offender_results.query = this.offender_search;

                $.post("http://wp_public_records/performOffenderSearch", JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (let key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    $.post("http://wp_public_records/viewOffender", JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post("http://wp_public_records/saveOffenderChanges", JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post("http://wp_public_records/performReportSearch", JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post("http://wp_public_records/submitNewReport", JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post("http://wp_public_records/getOffender", JSON.stringify({
                char_id: id
            }));
        },
        ToggleReportEdit() {
        ...
        DeleteSelectedReport() {
            $.post("http://wp_public_records/deleteReport", JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post("http://wp_public_records/saveReportChanges", JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post("http://wp_public_records/vehicleSearch", JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post("http://wp_public_records/getVehicle", JSON.stringify({
                vehicle: result
            }));
        },
        WarrantReportSearch() {
        ...
        SubmitNewWarrant() {
            ...
            $.post("http://wp_public_records/submitNewWarrant", JSON.stringify({
        ...
        SubmitNewBolo() {
            ...
            $.post("http://wp_public_records/submitNewBolo", JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post("http://wp_public_records/deleteWarrant", JSON.stringify({
        ...
        DeleteSelectedBolo() {
            $.post("http://wp_public_records/deleteBolo", JSON.stringify({
        ...
        OpenReportById(id) {
            $.post("http://wp_public_records/getReport", JSON.stringify({
                id: id
            }));
        },
        ...
        SentencePlayer() {
            $.post("http://wp_public_records/sentencePlayer", JSON.stringify({
                id: this.report_selected.id,
