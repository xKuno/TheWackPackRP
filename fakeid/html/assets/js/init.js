  ...
  window.addEventListener('message', function( event ) {
    if (event.data.action == 'open') {
      ...
      if ( type == 'driver' || type == null) {
        ...
        $('#name').text(userData.fakefirstname + ' ' + userData.fakelastname);
        $('#dob').text(userData.fakedateofbirth);
        $('#height').text(userData.fakeheight);
        $('#signature').text(userData.fakefirstname + ' ' + userData.fakelastname);
