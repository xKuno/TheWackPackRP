radioConfig = {
    Controls = {
        Activator = { -- Open/Close Radio
            Name = "INPUT_WHISTLE", -- Control name
            Key = 265, -- H Close radio
        },
        Secondary = {
            Name = "INPUT_SPRINT",
            Key = 21, -- Left Shift
    ...
    Frequency = {
        Private = { -- List of private frequencies
            ...
            [5] = true, -- Make 5 a private frequency
            [6] = true, -- Make 6 a private frequency
            [7] = true, -- Make 7 a private frequency
