...
Config.Bank = {
	...
	{id = 108, x = 4477.211, y = -4464.899, z = 4.252},
...
Config.ATM = {
    ...
    {id = 277, x = 472.41, y = -1001.56, z = 30.69}, -- MRPD Armory
    {id = 277, x = 468.46, y = -990.57, z = 26.27}, -- MRPD Basement
    {id = 277, x = 315.2, y = -593.66, z = 43.28}, -- Pillbox
}