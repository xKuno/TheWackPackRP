                            ...
                            if job == Config.JobRequired and grade >= Config.JobGradeRequired then
                                ...
                                if IsControlJustReleased(0, Keys[Config.PickupEvidenceKey]) then
                                    if #evidence < 3 then
                                        ...
                                        exports['mythic_notify']:SendAlert('inform', 'Evidence collected!', 2500)
                                        PlaySoundFrontend(-1, "PICK_UP", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
                                    else
                                        exports['mythic_notify']:SendAlert('inform', 'Not enough space for evidence 3/3!', 2500, { ['background-color'] = '#b50000', ['color'] = '#ffffff' })
                                    end
                                end
                            else
                                ...
                                if IsControlJustReleased(0, Keys[Config.PickupEvidenceKey]) then
                                    if (time - t) > Config.TimeBeforeCrimsCanDestory then
                                        ...
                                        TriggerServerEvent("core_evidence:removeBlood", t)
                                        exports['mythic_notify']:SendAlert('inform', 'Evidence Removed!', 2500)
                                        PlaySoundFrontend(-1, "PICK_UP", "HUD_FRONTEND_DEFAULT_SOUNDSET", false)
                                    else
                                        ...
                                        ESX.UI.Menu.Open(
                                            ...
                                            function(data2, menu2)
                                                ...
                                                elseif data2.current.value == "delete" then
                                                    ...
                                                    exports['mythic_notify']:SendAlert('inform', 'Evidence deleted from archive!', 2500)
                                                end
                                                menu2.close()
                                            end,
                                            function(data2, menu2)
                ...
                elseif GetDistanceBetweenCoords(coords, Config.EvidenceAlanysisLocation) < 1.5 then
                    ...
                    if IsControlJustReleased(0, 38) and not analyzing and not analyzingDone then
                        if #evidence > 0 then
                            Citizen.CreateThread(
                                function()
                                    exports['mythic_notify']:SendAlert('inform', 'The evidence is being alanyzed by forensics! Please Wait.', 2500)
                            ...
                            exports['mythic_notify']:SendAlert('inform', 'You have no evidence to analyze.', 2500)
                        end
...
AddEventHandler(
    ...
    function(report)
        Citizen.CreateThread(
            function()
                exports['mythic_notify']:SendAlert('inform', 'The car is being analyzed please wait.', 2500)
...
AddEventHandler(
    ...
    function()
        if IsPedInAnyVehicle(PlayerPedId(), false) then
            ...
            exports['mythic_notify']:SendAlert('inform', 'To use this you need to be in a vehicle.', 2500)
        end
    end
)
...
RegisterNetEvent('wp_evidence:processVan')
AddEventHandler('wp_evidence:processVan', function()
    if #evidence > 0 then
        exports['mythic_notify']:SendAlert('inform', 'The evidence is being alanyzed! Please Wait.', 10000)
...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/dropevidence', 'Drops the evidence you are carrying so you can pickup new evidence.')
end)

RegisterCommand('dropevidence', function()
    evidence = {}
    exports['mythic_notify']:SendAlert('inform', 'You disposed of the evidence you were carrying', 2500)
end)