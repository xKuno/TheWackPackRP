...
skeletalsystem.MenuKey = "U"
skeletalsystem.OpenWithHotkey = false  -- open with openSkelly command if choosing not to use hotkey.
skeletalsystem.UsingStress    = false   -- disables head damage timecycle modifier if using MF_Stress.
