...
local garages = { 
	[1] = { locked = false, camera = {x = -343.21, y = -137.54, z = 39.01, heading = 271.68}, driveout = {x = -338.73,y = -136.65,z = 38.25, heading = 270.72}, drivein = {x = -338.73,y = -136.65,z = 38.25, heading = 270.72}, outside = {x = -338.73,y = -136.65,z = 38.25, heading = 270.72}, inside = {x = -338.73,y = -136.65,z = 38.25, heading = 270.72}}, --Main
	[2] = { locked = false, camera = {x = 725.47, y = -1088.79, z = 22.17, heading = 270.48}, driveout = {x = 731.18,y = -1088.91, z = 21.41, heading = 270.97}, drivein = {x = 731.18,y = -1088.91, z = 21.41, heading = 270.97}, outside = {x = 731.18,y = -1088.91, z = 21.41, heading = 270.97}, inside = {x = 731.18,y = -1088.91, z = 21.41, heading = 270.97}},  --Airport Greenwich PKWY LS Customs
	[3] = { locked = false, camera = {x = -1153.62, y = -2002.04, z = 13.18, heading = 156.46}, driveout = {x = -1155.72,y = -2006.38, z = 12.42, heading = 157.46}, drivein = {x = -1155.72,y = -2006.38, z = 12.42, heading = 157.46}, outside = {x = -1155.72,y = -2006.38, z = 12.42, heading = 157.46}, inside = {x = -1155.72,y = -2006.38, z = 12.42, heading = 157.46}}, --Outside Airport
	[4] = { locked = false, camera = {x = 1174.63, y = 2645.79, z = 37.76, heading = 181.4}, driveout = {x = 1175.03,y = 2640.98, z = 37.0, heading = 182.41}, drivein = {x = 1175.03,y = 2640.98, z = 37.0, heading = 182.41}, outside = {x = 1175.03,y = 2640.98, z = 37.0, heading = 182.41}, inside = {x = 1175.03,y = 2640.98, z = 37.0, heading = 182.41}}, --Sandy
	[5] = { locked = false, camera = {x = 113.79, y = 6623.61, z = 31.79, heading = 44.14}, driveout = {x = 111.63,y = 6625.87, z = 31.03, heading = 45.22}, drivein = {x = 111.63,y = 6625.87, z = 31.03, heading = 45.22}, outside = {x = 111.63,y = 6625.87, z = 31.03, heading = 45.22}, inside = {x = 111.63,y = 6625.87, z = 31.03, heading = 45.22}}, --Beekers
	[6] = { locked = false, camera = {x = -210.07, y = -1320.9, z = 30.89, heading = 158.1}, driveout = {x = -211.28,y = -1324.13, z = 30.13, heading = 144.85}, drivein = {x = -211.28,y = -1324.13, z = 30.13, heading = 144.85}, outside = {x = -211.28,y = -1324.13, z = 30.13, heading = 144.85}, inside = {x = -211.28,y = -1324.13, z = 30.13, heading = 144.85}}, --Bennys
	[7] = { locked = false, camera = {x = 495.55, y = -1326.82, z = 29.33, heading = 161.67}, driveout = {x = 493.66,y = -1331.43, z = 28.58, heading = 140.42}, drivein = {x = 493.66,y = -1331.43, z = 28.58, heading = 140.42}, outside = {x = 493.66,y = -1331.43, z = 28.58, heading = 140.42}, inside = {x = 493.66,y = -1331.43, z = 28.58, heading = 140.42}}, --El-Rancho
	[8] = { locked = false, camera = {x = 972.03, y = -115.83, z = 74.35, heading = 50.44}, driveout = {x = 966.33, y = -109.63, z = 74.38, heading = 38.14}, drivein = {x = 966.33, y = -109.63, z = 74.38, heading = 38.14}, outside = {x = 966.33, y = -109.63, z = 74.38, heading = 38.14}, inside = {x = 966.33, y = -109.63, z = 74.38, heading = 38.14}}, --The LostMC
	[9] = { locked = false, camera = {x = 457.998, y = -980.575, z = 25, heading = 41.794}, driveout = {x = 450.58, y = -975.67, z = 25.7, heading = 93.147}, drivein = {x = 450.58, y = -975.67, z = 25.7, heading = 93.147}, outside = {x = 450.58, y = -975.67, z = 25.7, heading = 93.147}, inside = {x = -961.76,y = -2966.32, z = 13.19, heading = 93.147}}, --Gabz MRPD
	[10] = { locked = false, camera = {x = -964.97,y = -2970.8, z = 13.95, heading = 333.07}, driveout = {x = -961.76,y = -2966.32, z = 13.19, heading = 333.71}, drivein = {x = -961.76,y = -2966.32, z = 13.19, heading = 333.71}, outside = {x = -961.76,y = -2966.32, z = 13.19, heading = 333.71}, inside = {x = -961.76,y = -2966.32, z = 13.19, heading = 333.71}}, --Airport
	[11] = { locked = false, camera = {x = -1424.08, y = -449.14, z = 35.90, heading = 333.07}, driveout = {x = -961.76,y = -2966.32, z = 13.19, heading = 333.71}, drivein = {x = -1424.08, y = -449.14, z = 35.90, heading = 333.71}, outside = {x = -1424.08, y = -449.14, z = 35.90, heading = 333.71}, inside = {x = -1424.08, y = -449.14, z = 35.90, heading = 333.71}}, --Hayes Autos
	[12] = { locked = false, camera = {x = 374.33, y = 796.99, z = 187.28, heading = 333.07}, driveout = {x = -961.76,y = -2966.32, z = 13.19, heading = 333.71}, drivein = {x = 374.33, y = 796.99, z = 187.28, heading = 333.71}, outside = {x = 374.33, y = 796.99, z = 187.28, heading = 333.71}, inside = {x = -1424.08, y = -449.14, z = 35.90, heading = 333.71}}, --Ranger Station
}
...
AddEventHandler('LSC:installMod', function()
	...
	TriggerEvent("InteractSound_CL:PlayOnOne", 'wrench', 0.7)
end)
...
local function DriveInGarage()
	...
	if DoesEntityExist(veh) then
		...
		elseif	type(LSC_Config.menu.theme) == "string" then
			...
			elseif LSC_Config.menu.theme == "yellow" then	
				LSCMenu:setColors({ r = 255,g = 255, b = 255, a = 255},{ r = 255,g = 255, b = 255, a = 255},{ r = 0,g = 0, b = 0, a = 100},{ r = 229,g = 186, b = 14, a = 255})
		...
		LSCMenu:addPurchase("Repair vehicle",round(500+150*damage,0), "Full body repair and engine service.")
		...
		LSCMenu.categories:addSubMenu("FENDERS", "Fenders",nil, true)
		AddMod(8,LSCMenu.categories.Fenders,"LEFT FENDER", "Left Fender", "Enhance body paneling with custom fenders on the left side.",true)
		AddMod(9,LSCMenu.categories.Fenders,"RIGHT FENDER", "Right Fender", "Enhance body paneling with custom fenders on the right side.",true)
		...
		LSCMenu.categories:addSubMenu("WHEELS", "Wheels", "Custom rims, tires and colors.",true)
			wtype = LSCMenu.categories.Wheels:addSubMenu("WHEEL TYPE", "Wheel type", "Custom rims in all styles and sizes.",true)
				if IsThisModelABike(GetEntityModel(veh)) then
					...
					cfwheels = wtype:addSubMenu("CHROME FRONT WHEEL", "Chrome Front wheel", nil,true)
						for n, w in pairs(LSC_Config.prices.chromefrontwheel) do
							btn = cfwheels:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					cbwheels = wtype:addSubMenu("CHROME BACK WHEEL", "Chrome Back wheel", nil,true)
						for n, w in pairs(LSC_Config.prices.chromebackwheel) do
							btn = cbwheels:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 24 btn.mod = w.mod
						end	
				else
					...
					csportw = wtype:addSubMenu("CHROME SPORT WHEELS", "Chrome Sport", nil,true)
						for n, w in pairs(LSC_Config.prices.csportwheels) do
							local btn = csportw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end	
					...
					cmusclew = wtype:addSubMenu("CHROME MUSCLE WHEELS", "Chrome Muscle", nil,true)
						for n, w in pairs(LSC_Config.prices.cmusclewheels) do
							local btn = cmusclew:addPurchase(w.name,w.price)btn.wtype =  w.wtype btn.modtype = 23 btn.mod = w.mod
						end	
					...
					clowriderw = wtype:addSubMenu("CHROME LOWRIDER WHEELS", "Chrome Lowrider", nil,true)
						for n, w in pairs(LSC_Config.prices.clowriderwheels) do
							local btn = clowriderw:addPurchase(w.name,w.price)btn.wtype =  w.wtype btn.modtype = 23 btn.mod = w.mod
						end	
					...
					csuvw = wtype:addSubMenu("CHROME SUV WHEELS", "Chrome Suv", nil,true)
						for n, w in pairs(LSC_Config.prices.csuvwheels) do
							local btn = csuvw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end	
					...
					coffroadw = wtype:addSubMenu("CHROME OFFROAD WHEELS", "Chrome Offroad", nil,true)
						for n, w in pairs(LSC_Config.prices.coffroadwheels) do
							local btn = coffroadw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end	
					...
					ctunerw = wtype:addSubMenu("CHROME TUNER WHEELS", "Chrome Tuner", nil,true)
						for n, w in pairs(LSC_Config.prices.ctunerwheels) do
							local btn = ctunerw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end	
					...
					chughendw = wtype:addSubMenu("CHROME HIGHEND WHEELS", "Chrome Highend", nil,true)
						for n, w in pairs(LSC_Config.prices.chighendwheels) do
							local btn = chughendw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end	
					originalw = wtype:addSubMenu("BENNYS ORIGINALS", "Bennys Original", nil,true)
						for n, w in pairs(LSC_Config.prices.originalwheels) do
							local btn = originalw:addPurchase(w.name,w.price)btn.wtype = w.wtype btn.modtype = 23 btn.mod = w.mod
						end
					bespokew = wtype:addSubMenu("BENNYS BESPOKE", "Bennys Bespoke", nil,true)
...
local function DriveOutOfGarage(pos)
	Citizen.CreateThread(function()
		...
		TriggerServerEvent("LSC:UpdateDatabase", vehprops)
	...
	while true do
		...
		if inside == false then
			...
			if IsPedSittingInAnyVehicle(ped) then
				...
				if DoesEntityExist(veh) and GetPedInVehicleSeat(veh, -1) == ped and (IsThisModelACar(GetEntityModel(veh)) or IsThisModelAQuadbike(GetEntityModel(veh)) or IsThisModelABike(GetEntityModel(veh))) or IsThisModelAHeli(GetEntityModel(veh)) or IsThisModelAPlane(GetEntityModel(veh)) or IsThisModelAJetski(GetEntityModel(veh)) or IsThisModelABoat(GetEntityModel(veh)) then
...
AddEventHandler("LSC:buttonSelected", function(name, button, canpurchase)
	...
	elseif mname == "right fender" then
		if button.name == "Stock" or button.purchased or CanPurchase(price, canpurchase)then
			if button.name == "Stock" then
	...
	elseif mname == "sport" or mname == "muscle" or mname == "lowrider" or mname == "chrome sport" or mname == "chrome muscle" or mname == "chrome lowrider" or mname == "back wheel" or mname == "front wheel" or mname == "chrome back wheel" or mname == "chrome front wheel" or mname == "highend" or mname == "suv" or mname == "offroad" or mname == "tuner" or mname == "chrome highend" or mname == "chrome suv" or mname == "chrome offroad" or mname == "chrome tuner" or mname == "bennys bespoke" or mname == "bennys original" then
		if button.purchased or CanPurchase(price, canpurchase) then
...
function LSCMenu:OnMenuChange(last,current)
	...
	elseif c == "left fender" then
		---MoveVehCam('left',-1.8,-1.3,0.7)
	elseif c == "right fender" then
		---MoveVehCam('left',-1.8,-1.3,0.7)
	...
	elseif c == "back wheel" or c == "chrome back wheel" then
		---PointCamAtBone("wheel_lr",-1.4,0,0.3)
	elseif c == "front wheel" or c == "chrome front wheel" or c == "wheel accessories" or  c == "wheel color" or c == "sport" or c == "muscle" or c == "lowrider"  or c == "highend" or c == "suv" or c == "offroad" or c == "tuner" or c == "chrome sport" or c == "chrome muscle" or c == "chrome lowrider"  or c == "chrome highend" or c == "chrome suv" or c == "chrome offroad" or c == "chrome tuner" or c == "bennys bespoke" or c == "bennys original" then
...
function CheckPurchases(m)
	...
	elseif name == "armor" or name == "suspension" or name == "transmission" or name == "brakes" or name == "engine tunes" or name == "roof" or name == "left fender" or name == "right fender" or name == "hood" or name == "grille" or name == "roll cage" or name == "exhausts" or name == "skirts" or name == "rear bumpers" or name == "front bumpers" or name == "spoiler" then
		for i,b in pairs(m.buttons) do
			if b.mod == -1  then
	...
	elseif name == "sport" or name == "muscle" or name == "lowrider" or name == "chrome sport" or name == "chrome muscle" or name == "chrome lowrider" or name == "back wheel" or name == "front wheel" or name == "chrome back wheel" or name == "chrome front wheel" or name == "highend" or name == "suv" or name == "offroad" or name == "tuner" or name == "chrome highend" or name == "chrome suv" or name == "chrome offroad" or name == "chrome tuner"  or name == "bennys bespoke" or name == "bennys original" then
		for i,b in pairs(m.buttons) do
...
AddEventHandler('onResourceStart', function(resourceName)
	if ("esx_lscustomsV2" == resourceName) then
		AddBlips()
		TriggerServerEvent('getGarageInfo')
	end
end)
