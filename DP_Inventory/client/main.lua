...
RegisterKeyMapping('openselfinventory', 'Inventory Open', 'keyboard', 'F2')

RegisterCommand('openselfinventory', function()
...
RegisterKeyMapping('quickslots', 'View Quick Slots', 'keyboard', 'TAB')

RegisterCommand('quickslots', function()
	if not IsPlayerDead(PlayerId()) then
		HudForceWeaponWheel(false)
		showHotbar()
	end
...
RegisterKeyMapping('slot1', 'Inventory Slot 1', 'keyboard', '1')
...
RegisterKeyMapping('slot2', 'Inventory Slot 2', 'keyboard', '2')
...
RegisterKeyMapping('slot3', 'Inventory Slot 3', 'keyboard', '3')
...
RegisterKeyMapping('slot4', 'Inventory Slot 4', 'keyboard', '4')
...
RegisterKeyMapping('slot5', 'Inventory Slot 5', 'keyboard', '5')
	...
	Citizen.CreateThread(function()
		...
		ESX.TriggerServerCallback("DP_Inventory:getPlayerInventoryWeight", function(cb)
			...
			SendNUIMessage({
				...
				text =  "<strong>         "..tostring(playerweight).."/"..tostring(maxWeight).."LBS<strong>"
			})
			weight = playerweight
...
RegisterNUICallback("DropItem",function(data, cb)
	...
	if type(data.number) == "number" and math.floor(data.number) == data.number then
		TriggerServerEvent("DP_Inventory:logdrop", data.number, data.item.name)
